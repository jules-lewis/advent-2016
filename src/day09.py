...
#Sample of string = "LGOFNEIZBERESE(15x10)WREHFFHTWBHRRRU(53x15)(8x13)ZSLUBGUV(2x10)BP"
#RegEx to match the bracketed parts [https://regexr.com/6t9ej] = r'\(\d+x\d+\)'
...
def decompress(l_data, pattern, part1):
    ...
    if match:
        ...
        l, r = match.span()
        length, repeat = [int(i) for i in l_data[l+1:r-1].split('x')]
        before = l_data[:l]
